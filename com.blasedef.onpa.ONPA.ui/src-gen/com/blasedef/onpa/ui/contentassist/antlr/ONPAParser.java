		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPredicatesAccess().getGroup(), "rule__Predicates__Group__0");
					...
					put(grammarAccess.getValueExpressionAccess().getNameAssignment_0(), "rule__ValueExpression__NameAssignment_0");
