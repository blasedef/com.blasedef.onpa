 ...
 * <ul>
 *   <li>{@link com.blasedef.onpa.oNPA.impl.OutImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutImpl extends EvaluationsImpl implements Out
{
  ...
  {
    return ONPAPackage.Literals.OUT;
  }
  ...
  public EList<EvaluationExpressionOut> getExpressions()
  {
    if (expressions == null)
    {
      expressions = new EObjectContainmentEList<EvaluationExpressionOut>(EvaluationExpressionOut.class, this, ONPAPackage.OUT__EXPRESSIONS);
    }
    return expressions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ONPAPackage.OUT__EXPRESSIONS:
