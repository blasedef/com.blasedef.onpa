...
public class ValuesImpl extends MinimalEObjectImpl.Container implements Values
{
   ...
   * @ordered
   */
  protected EList<ValuePrimary> values;
   ...
   * @generated
   */
  public EList<ValuePrimary> getValues()
  {
    if (values == null)
    {
      values = new EObjectContainmentEList<ValuePrimary>(ValuePrimary.class, this, ONPAPackage.VALUES__VALUES);
    }
    return values;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case ONPAPackage.VALUES__VALUES:
        getValues().clear();
        getValues().addAll((Collection<? extends ValuePrimary>)newValue);
        return;
    }
